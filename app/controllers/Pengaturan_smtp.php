...
class Pengaturan_smtp extends BUKUTAMU_Core {
	...
	public function index()
	{
		...
		$this->_module 	= 'utilitas/smtp_view';
		
		$this->js 		= 'halaman/pengaturan_smtp';
		
		$this->_data 	= array(
			'title' 	=> $this->app->app_title . ' - Pengaturan SMTP',
			'smtp'		=> $this->smtp,
		);
	...
	private function _rulesSMTP()
	{
		$rules = array(
			...
			array(
				'field' => 'smtp_crypto',
				'label' => 'Enkripsi SMTP',
				'rules' => 'trim|required|regex_match[/(ssl|tls)$/]',
				'errors'=> array(
					'required' => '{field} harus diisi.',
					'regex_match'=> '{field} harus SSL atau TLS.'
				)
			),
			array(
				'field' => 'smtp_password',
