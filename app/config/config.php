...
$config['sess_cookie_name'] = 'bukutamu_session';
...
|
*/
$config['cookie_prefix']    = 'bukutamu_';
...
$config['csrf_token_name'] = 'bukutamu_token'; // JANGAN DIUBAH, NANTI MAMBAK!!!
